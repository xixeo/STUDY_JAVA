...
public class test_객체배열리스트정렬comparator {
	...
	static void sortStudents(Student[] students) {
		Arrays.sort(students, (s1, s2) -> Integer.parseInt(s1.sno) - Integer.parseInt(s2.sno));
	}

	// 주어진 메시지와 학생 리스트를 받아서 각 학생의 학번과 이름을 출력
	public static void main(String[] args) {
		...
		Collections.sort(sList, (s1, s2) -> Integer.parseInt(s1.sno) - Integer.parseInt(s2.sno));
